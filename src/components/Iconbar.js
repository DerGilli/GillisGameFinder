...
const Iconbar = ({ redditLink, website }) => {
  return (
    <div className="Iconbar">
      ...
      {redditLink && <a target="_blank" rel="noreferrer" href={redditLink}><FontAwesomeIcon className="icon" icon={faRedditAlien} /></a>}
      {website && <a target="_blank" rel="noreferrer" href={website}><FontAwesomeIcon className="icon" icon={faGlobe} /></a>}
